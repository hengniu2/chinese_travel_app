...
/// Premium floating info card: name, tags, score, address, map CTA.
class HotelDetailInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.symmetric(horizontal: HotelUIConstants.grid2.w),
      padding: EdgeInsets.all(HotelUIConstants.grid3.w),
      decoration: BoxDecoration(
        color: theme.colorScheme.surface,
        borderRadius: BorderRadius.circular(HotelUIConstants.cardRadius + 4),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              if (detail.tagBadge != null && detail.tagBadge!.isNotEmpty) ...[
                SizedBox(width: 8.w),
          ...
          if (detail.tags.isNotEmpty) ...[
            ...
            Wrap(
              spacing: 8.w,
              runSpacing: 6.h,
              children: detail.tags.take(5).map((t) => _FeatureTag(label: t)).toList(),
            ),
          ],
...
/// Rating badge with pop-in animation (scale 0.5 → 1, 300ms easeOut).
...
class _LocationRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Icon(Icons.location_on_rounded, size: 18.sp, color: AppColors.accentGold),
        SizedBox(width: 8.w),
        Expanded(
          child: Text(
            address,
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Icons.map_outlined, size: 18.sp, color: AppColors.accentGold),
                    SizedBox(width: 4.w),
                    Text(
                      '地图',
