...
class HotelDetailPolicySection extends StatefulWidget {
  ...
  @override
  State<HotelDetailPolicySection> createState() => _HotelDetailPolicySectionState();
}
...
class _HotelDetailPolicySectionState extends State<HotelDetailPolicySection> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Padding(
          padding: EdgeInsets.only(left: 4.w, bottom: HotelUIConstants.grid2.h),
          child: Text(
            '酒店政策',
...
class _PolicyTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(bottom: HotelUIConstants.grid2.h),
