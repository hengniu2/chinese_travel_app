...
/// 酒店详情顶部轮播：全宽、圆角底、自动轮播、指示点、缩略图条、底部渐变
class HotelDetailBanner extends StatefulWidget {
  ...
  /// When false, back/share/favorite are omitted (e.g. when used inside SliverAppBar).
...
class _HotelDetailBannerState extends State<HotelDetailBanner> {
  ...
  List<String> get _images {
    ...
    if (widget.detail.imageUrl != null && widget.detail.imageUrl!.isNotEmpty) {
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          // Top overlay: back, share, favorite (optional when used in SliverAppBar)
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _OverlayButton(icon: Icons.share_rounded, onTap: widget.onShareTap ?? () {}),
                        SizedBox(width: 8.w),
                        _OverlayButton(
                ...
                children: List.generate(
                  ...
                  (i) => AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: _currentIndex == i ? Colors.white : Colors.white.withValues(alpha: 0.5),
                    ),
                  ),
                ),
              ),
  ...
  void _scrollThumbTo(int index) {
    ...
    final itemWidth = 56.0 + 8; // thumb width + margin
  ...
  Widget build(BuildContext context) {
    return CachedNetworkImage(
      ...
      errorWidget: (_, __, ___) => Container(
        ...
        child: Center(
          child: Icon(Icons.hotel_rounded, size: 64, color: AppColors.accentGold.withValues(alpha: 0.5)),
        ),
      ),
    );
  }
...
class _PlaceholderBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      color: AppColors.warmBackground,
      child: Center(
        child: Icon(Icons.hotel_rounded, size: 80, color: AppColors.accentGold.withValues(alpha: 0.5)),
      ),
    );
  }
}
