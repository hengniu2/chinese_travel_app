...
/// Maps canonical Hotel to detail DTO (Room -> RoomType).
...
/// Maps Room to RoomType for detail UI.
RoomType roomToType(Room r) {
  ...
  final pricePlans = <RoomPricePlan>[
    ...
    RoomPricePlan(
      label: r.isRefundable ? '限时免费取消' : '不可取消',
      price: r.isRefundable ? r.price : r.price * 0.88,
    ),
  ];
  return RoomType(
    id: r.id,
