...
/// Facilities grid: icon + label per facility.
class HotelDetailFacilitiesGrid extends StatelessWidget {
  ...
  IconData _iconFor(String name) {
    if (iconsMap != null && iconsMap!.containsKey(name)) {
      ...
      children: [
        ...
        GridView.builder(
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            crossAxisCount: 4,
            mainAxisSpacing: HotelTheme.grid2.h,
            crossAxisSpacing: HotelTheme.grid2.w,
